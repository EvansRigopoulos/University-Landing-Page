...
<script>    
                ...
                var row = document.getElementById("row");
                    ...
                    for(var i=1;i<table.rows.length;i++){
                                ...
                                var grade = table.rows[i].cells[5].innerHTML;
                                var usersemester =" <?=$semester?>";
                                var currentsemester = table.rows[i].cells[0].innerHTML;
                                console.log(usersemester>=currentsemester);
                                if(grade>5){
                                    table.rows[i].style.backgroundColor="lightgreen";
                                }else if(grade===""  &&  usersemester<currentsemester ){
